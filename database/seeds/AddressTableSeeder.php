...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $cityCollection = collect($data)->map(function($city) {
            $addCity = City::firstOrCreate([
                'name' => $city['name'],
            ]);
        ...
        $district = $city->pluck('cities');
        $districtInCity = collect($district)->map(function($oneDistrict) {
            $districtCollection = collect($oneDistrict)->map(function($districtName){
                $addDistrict = District::firstOrCreate([
                    'name' => $districtName,
                ]);
            });
